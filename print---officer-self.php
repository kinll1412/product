...
<body>
  ...
  <form method="post" name="form1" id="form1">
    <div id="printablediv">
      ...
      <!-- <div id="print_h">
        ...
        <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#" style="padding-bottom: 60px;padding-top: 10px;">
          ...
          <div class="sidebar-brand-text mx-3">
            <span style="color: #000000;font-family: TH SarabunPSK, sans-serif;font-size: 28px; margin-bottom: 0px;"><b>รายละเอียดประมาณการจัดซื้อครุภัณฑ์ สายพลาธิการ<br><center><?php echo $data['order_owner']; ?></center></b></span>
            ...
            ?>
              ...
              <tr>
                ...
                <td align='right'> <?php $total1 = $data1['detail_total'] / $data1['detail_qty'];
                                    echo number_format($total1); ?></td>
                <td align='right'><?= number_format($data1['detail_total']) ?></td>
                <td>
                  <center>-</center>
                </td>
                <td>
      ...
      <!-- <table style="width:100%;background-color:#ff0000;">
        <tr>
          <td>
            <div style="font-family: Sarabun;font-size: 14px;position:fixed;text-align:center;width:70%;"><b>น.ท.</b></div><br>
          </td>
        </tr>
        <tr>
          <td>
            <div style="font-family: Sarabun;font-size: 14px;position:fixed;text-align:center;width:80%;"><b>(สุพล ก่ายแก้ว)</b></div><br>
          </td>
        </tr>
        <tr>
          <td>
            <div style="font-family: Sarabun;font-size: 14px;position:fixed;text-align:center;width:80%;"><b>หน.ผจง.กพพ.พธ.ทอ.</b></div><br>
          </td>
        </tr>
        <tr>
          <td>
            <div style="font-family: Sarabun;font-size: 14px;position:fixed;text-align:center;width:80%;"><b id="approve-date"><?php echo thai_date_short($dateData); ?></b></div>
          </td>
        </tr>
      </table> -->
  ...
  $alert2 .= 'window.location="officer_order_status.php"}';
