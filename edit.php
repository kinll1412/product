...
<body style="font-family: Sarabun, sans-serif;border-style: none;">
    ...
    $product_pdf = $data['product_pdf'];
    ?>
    <form class="form-horizontal text-nowrap" action="update.php" method="post" enctype="multipart/form-data">
        <div class="container">
                ...
                <div class="card-body">
                    <div class="row profile-row">
                            ...
                            <div class="avatar">
                                <div class="row">
                                    <div class="col d-lg-flex justify-content-lg-center align-items-lg-center mb-2">
                                        <div class="mb-2">
                                            <img class="rounded-circle my-n1"src="upload/img/<?php if (empty($data['product_img'])) {
                                                                        echo "pic.png";
                                                                    }
                                                                    echo $data['product_img']; ?>" id="preview" class="d-lg-flex justify-content-lg-center align-items-lg-center" style="height: 330px" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col d-lg-flex justify-content-lg-center align-items-lg-center">
                                        <input type="hidden" name="product_img" value="<?php echo $data['product_img']; ?>">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    <div class="form-group mb-3"><label class="form-label">ชื่อคุณลักษณะครุภัณฑ์</label>
                                        <input type="text" name="product_attribute" class="form-control form-control-sm" value="<?= $data['product_attribute'] ?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    <div class="form-group mb-3"><label class="form-label">ไฟล์คุณลักษณะรายละเอียด</label>
                                        <input type="hidden" name="product_pdf" value="<?php echo $product_pdf; ?>">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    <div class="form-group mb-3"><label class="form-label">วันที่ลงคุณลักษณะ</label>
                                    <input type="text" name="product_date" class="form-control form-control-sm" value="<?= $data['product_date'] ?>" />
