    ...
    <div id="printablediv"> 
      ...
      <!-- หัวรายงาย start-->
        <div id="print_h">
          ...
          <span style="color:#000000;font-family: Sarabun, sans-serif;font-size: 28px;"><b></b></span>
          </p>
          ...
          <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#" style="padding-bottom: 80px;padding-top: 40px;">
            ...
            <div class="sidebar-brand-text mx-3">
                <span style="color: #000000;font-family: TH SarabunPSK, sans-serif;font-size: 38px; margin-bottom: 0px;"><b>รายละเอียดประมาณการจัดซื้อครุภัณฑ์ สายพลาธิการ</b></span>
                ...
                <!--    <div class="row">
                  ...
                  <table class="table table-bordered table-sm align-middle">
                    ...
                    <tbody>
                     ...
                     <td><center> 
         <?php            
           echo ' <a href="print---admin.php?order_id='.$data['order_id'].'&print=print" class="btn btn-outline-success"><span class="fas fa-print" style="font-size: 16px;width: 16px;height: 16px;"></span>&nbsp;&nbsp;พิมพ์</a>';
         ?>
          </center>
       </td>  
       &nbsp;&nbsp;<br>
...
<table style="width:100%">
  <tr>    
    ...
    <div style="font-family: Sarabun;font-size: 16px;position:fixed;text-align:right;width:87%;"><b>&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;</b></div>
  </tr>   
  </table>
</div> 
