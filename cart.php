                ...
                <div class="container">
                    <div class="col">
                        <div class="card shadow mb-3">
                            <div class="card-body">
                                <form class="frmcart" id="frmcart" name="frmcart" method="post" onsubmit="return emtryOrderName()" action="confirm.php">
                                    <div class="table-responsive">
                                        <p style="text-align:center"> <a class="btn btn-primary" onclick="sendCart()">กลับไปเลือกครุภัณฑ์</a> </p>
                                        <form>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if (!empty($_SESSION['cart'])) {
                                                            ...
                                                            foreach ($_SESSION['cart'] as $product_id => $qty) {
                                                                ...
                                                                //remove product
                                                                echo "<td><center><a href='cart.php?product_change=$product_id&status=remove' class='btn btn-danger btn-xs'>ลบ</a></center></td>";
                                                                echo "</tr>";
                                                            }
